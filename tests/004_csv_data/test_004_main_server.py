...
class TestPostOfficeDatabase(unittest.TestCase):
    def setUp(self):
        ...
        writer.writerow(['package_id', 'delivery_guy', 'weight_kg', 'size_cm', 'sender_name', 'sender_address', 'receiver_name', 'receiver_address', 'label'])
...
class TestMCPServer(unittest.TestCase):
    ...
    def test_mcp_factory(self):
        ...
        self.mock_db.get_packages_for_delivery_guy.return_value = [
            {'package_id': 'PKG001', 'label': 'FRAGILE', 'weight_kg': '2.5', 'size_cm': '10x10', 'sender_name': 'A', 'sender_address': 'B', 'receiver_name': 'C', 'receiver_address': 'D'}
        ]
        result = tool(1)
        ...
        self.mock_db.get_package_details.return_value = {
            'package_id': 'PKG001', 'delivery_guy': '1', 'label': 'FRAGILE', 'weight_kg': '2.5', 'size_cm': '10x10', 'sender_name': 'A', 'sender_address': 'B', 'receiver_name': 'C', 'receiver_address': 'D'
        }
        result = tool('PKG001')
        self.assertIn("PKG001", result)
    ...
    def test_search_packages_by_label_tool(self):
        ...
        self.mock_db.packages = [
            {'package_id': 'P1', 'label': 'FRAGILE', 'delivery_guy': 1, 'state': 'pending', 'weight_kg': 1.0, 'receiver_name': 'R1'},
            {'package_id': 'P2', 'label': 'STANDARD', 'delivery_guy': 2, 'state': 'delivered', 'weight_kg': 2.0, 'receiver_name': 'R2'}
        ]
    ...
    def test_get_packages_by_state_tool(self):
        ...
        self.mock_db.packages = [
            {'package_id': 'P1', 'state': 'pending', 'delivery_guy': 1, 'label': 'L1', 'weight_kg': 1.0, 'receiver_name': 'R1'},
            {'package_id': 'P2', 'state': 'delivered', 'delivery_guy': 2, 'label': 'L2', 'weight_kg': 2.0, 'receiver_name': 'R2'}
        ]
